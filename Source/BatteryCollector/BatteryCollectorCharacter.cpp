...
void ABatteryCollectorCharacter::CalculateHealth(float Delta)
{
	Health += Delta;
	CalculateDead();
}
...
void ABatteryCollectorCharacter::CalculateDead()
{
	if (Health <= 0)
		isDead = true;
	else
...
void ABatteryCollectorCharacter::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	isDead = false;
	Health = 100;
